...
ActiveRecord::Schema.define(version: 20140219214401) do
  ...
  add_index "clients", ["business_name", "status_id"], name: "index_clients_on_business_name_and_status_id", unique: true, using: :btree
